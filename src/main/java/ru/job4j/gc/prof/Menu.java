...
public class Menu {
    ...
    public static final String BEGIN = " Start sorting - ";

    public static final String END = " End sorting - ";
    ...
    public static final String MENU = """
                Enter 1 to create an array.
                                 Enter 2 to start a merge sort.
                                 Type 3 to start bubble sort.
                                 Type 4 to start insertion sort.
